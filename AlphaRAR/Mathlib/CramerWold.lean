...
This is a verbatim vendoring (adapted to non-`module` syntax) of Mathlib PR #40345
(`Mathlib/Probability/CramerWold.lean`, author Ivo Malinowski), pending its merge into Mathlib.
It proves one direction of the Cramér–Wold device.
