...
\lean{AlphaRAR.IsLittleOpOne.add, AlphaRAR.IsBigOpOne.add, AlphaRAR.IsBigOpOne.add_littleOp, AlphaRAR.IsBigOpOne.mul_littleOp, AlphaRAR.IsBigOpOne.bdd_mul}\leanok
\uses{def:op_Op}
...
\lean{AlphaRAR.predQuadVar_succ_sub_eq}\leanok
\uses{def:pred_qv}
...
\lean{AlphaRAR.integral_sq_eq_integral_predQuadVar}\leanok
...
is a martingale. Expanding $\langle M+N\rangle$ with Lemma~\ref{lem:qv_incr} and
using the hypothesis gives additivity.
\end{proof}
